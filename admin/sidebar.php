    ...
    <div class="sidebar-body">
        <ul class="sidebar-nav">
            ...
            <?php if (in_array($role_user, ['admin'])): ?>
             <li class="sidebar-item">
                <a class="sidebar-link <?php echo ($current_page == 'checklist_kamar.php') ? 'active' : ''; ?>" href="../housekeeping/checklist_kamar.php">
                    <i class="bi bi-check2-square"></i>
            ...
            <li class="sidebar-item">
                ...
                <div class="sidebar-submenu collapse <?php echo $is_manajemen_page ? 'show' : ''; ?>" id="submenu-manajemen">
                    <ul class="sidebar-nav">
                        <li class="sidebar-item">
                             <a href="../manajemen/manajemen_properti.php" class="sidebar-link submenu-link <?php echo ($current_page == 'manajemen_properti.php') ? 'active' : ''; ?>">
                                <span>Properti</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                             <a href="../manajemen/manajemen_kamar.php" class="sidebar-link submenu-link <?php echo ($current_page == 'manajemen_kamar.php') ? 'active' : ''; ?>">
                                <span>Kamar</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
